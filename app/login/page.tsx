            ...
            <div className="w-full max-w-[380px] mx-auto flex flex-col h-full justify-center relative z-10">
                ...
                <form className="w-full space-y-5" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        ...
                        {mode === "login" && (
                            <div className="flex justify-end">
                                <a className="text-[13px] font-semibold text-primary hover:text-primary-hover transition-colors" href="#">비밀번호를 잊으셨나요?</a>
                            </div>
                        )}
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full rounded-full bg-primary hover:bg-primary-hover py-4 text-white text-[17px] font-bold tracking-wide shadow-lg shadow-primary/25 active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                        {loading ? (
                    ...
                    <div className="relative py-2">
                        ...
                        <div className="relative flex justify-center">
                            <span className="bg-background-light dark:bg-background-dark px-4 text-xs font-semibold text-gray-400 uppercase tracking-widest">또는</span>
                        </div>
                    </div>
