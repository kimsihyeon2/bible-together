...
async def run_test():
    ...
    try:
        ...
        # -> Click on the first active cell to open Bible Reading View and start reading verses.
        ...
        # -> Simulate quick user interactions such as fast tapping on verses to trigger real-time underlining updates.
        frame = context.pages[-1]
        # Simulate quick tap on verse 1 to trigger underlining update.
        elem = frame.locator('xpath=html/body/div[2]/main/div[2]/div/div').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Verify that underlining updates instantly without lag, overlap, or UI issues by simulating fast scrolling or additional fast tapping on verses.
        await page.mouse.wheel(0, 300)
        

        # -> Simulate rapid tapping on multiple different verses in quick succession to test underlining responsiveness and UI stability.
        frame = context.pages[-1]
        # Simulate quick tap on verse 3 to trigger underlining update.
        elem = frame.locator('xpath=html/body/div[2]/main/div[2]/div/div[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Simulate quick tap on verse 5 to trigger underlining update.
        elem = frame.locator('xpath=html/body/div[2]/main/div[2]/div/div[5]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Simulate quick tap on verse 7 to trigger underlining update.
        elem = frame.locator('xpath=html/body/div[2]/main/div[2]/div/div[7]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Simulate fast scrolling up and down multiple times to verify underlining updates correctly and without lag.
        await page.mouse.wheel(0, -300)
